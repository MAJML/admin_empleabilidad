...
class AvisosModel extends Model
{
    ...
    public function ListarAvisosPorFechas($fecha_inicial, $fecha_final, $validacion){
        ...
        WHERE A.created_at BETWEEN '".$fecha_inicial." 00:00:00' AND '".$fecha_final." 23:59:59' AND A.deleted_at IS NULL ".$validacion."");
        $query->execute();
