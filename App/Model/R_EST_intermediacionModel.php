...
class R_EST_intermediacionModel extends Model
{
    ...
    public function ListarIntermediacionPorFecha($fecha_inicial, $fecha_final, $programa_estudio, $grado_academico, $estado_estudiante)
    {
        ...
        where ALV.created_at BETWEEN '".$fecha_inicial." 00:00:00' AND '".$fecha_final." 23:59:59' AND AL.deleted_at is null AND AV.deleted_at is null ".$programa_estudio." ".$grado_academico." ".$estado_estudiante."");
        $query->execute();
