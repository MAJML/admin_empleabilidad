                ...
                <div class="page-title-heading">
                    <div>
                        <div class="page-title-head center-elem">
                            <span class="d-inline-block">| Avisos</span>
                        </div>
        ...
        <div class="row">
            <div
                ...
                <form action="" class="d-flex flex-wrap col-12" role="form" method="post" id="ConsultaPJ">
                    ...
                    <div class="mb-2 margen-right col-md-3">
                        <label for="" class="achicar-bottom"><b>PROGRAMA DE ESTUDIOS :</b></label>
                        <select class="form-control form-control-sm input-xs validacion" name='validacion' required>
                            <option value="and A.solicita_carrera=1">ENFERMERÍA TÉCNICA</option>
                            <option value="and A.solicita_carrera=2">FARMACIA TÉCNICA</option>
                            <option value="and A.solicita_carrera=3">TÉCNICA EN FISIOTERAPIA Y REHABILITACION</option>
                            <option value="and A.solicita_carrera=4">TÉCNICA EN LABORATORIO CLINICO</option>
                            <option value="and A.solicita_carrera=5">PRÓTESIS DENTAL</option>
