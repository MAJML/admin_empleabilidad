    ...
    <div class="card-header-tab card-header">
        ...
        <div class="btn-actions-pane-right text-capitalize">
            <div class="d-inline-block pr-3 d-flex">
                <input type="text" class="form-control data_input_fecha" name="daterange" value="">
                <button type="button" class="btn btn-primary d-flex consultar_data_fecha"><i
                        class="fa-solid fa-magnifying-glass pt-1" style="margin-right:10px;"></i> Consultar</button>
            </div>
        </div>
    </div>
