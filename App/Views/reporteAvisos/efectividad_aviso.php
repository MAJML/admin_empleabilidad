                ...
                <div class="page-title-heading">
                    <div>
                        <div class="page-title-head center-elem">
                            <span class="d-inline-block">| Reporte Avisos || Efectividad por Aviso</span>
                        </div>
                        <div class="page-title-subheading opacity-10">
                            <nav class aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a>Reporte Avisos / Efectividad por Aviso</a>
                                    </li>
                                </ol>
                            </nav>
                        </div>
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-12 d-flex flex-wrap justify-content-sm-center justify-content-lg-start justify-content-center w-100 p-1">
                <form action="" class="d-flex flex-wrap col-12" role="form" method="post" id="ConsultEfectividadAviso">
                    ...
                    <div class="mb-2 margen-right col-md-3">
                        <label for="" class="achicar-bottom"><b>ESTADO DE POSTULACIÓN :</b></label>
                        <select class="form-control form-control-sm input-xs estado_estudiante" name='estado_estudiante' required>
                            ...
                            <option value=" and ALV.estado_id in(2)">EVALUADO</option>
                            <option value=" and ALV.estado_id in(4)">ACEPTADO</option>
                            <option value=" and ALV.estado_id in(5)">DESCARTADO</option>
            ...
            <div class="col-md-12 mb-3">
                <div class="card">
                    <div class="card-header app-page-title text-white">
                        RESUMEN - GRÁFICO AVISOS GENERALES
                    </div>
                    <div class="card-body">
    ...
    <div class="card-footer justify-content-center">
        <div class="row col-md-12">
            <div class="p-0 card col-md-12">
                ...
                <div class="card-header app-page-title text-white">
                    DETALLE CANTIDAD DE POSTULACIONES SEGÚN AVISO
                </div>

                <div class="card-body">
                    <table id="TableEfectividadAv" class="display responsive no-wrap table table-bordered table-hover table-condensed TableValidacion"
                    width='100%'>
                        <thead class="cabezera_tabla">
                            <tr>
                                ...
                                <th>CANTIDAD DE POSTULADOS POR AVISO</th>
                            </tr>
                        </thead>
...
<script src="js/reporteAvisos/efectividadAviso.js"></script>