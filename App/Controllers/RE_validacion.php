...
class RE_validacion
{
    ...
    {
        View::render(["reporteEmpleador/validacion"]);
    }
...
/*     public function ContarActividadEcoPorFechas()
    ...
    public function EsportarExcel()
    {
        ...
        $hoja1 -> getProperties()->setCreator("Reporte de Excel Empleadores Validados")->setTitle('Mi Excel');

        /* TITULO EXCEL */
        $hoja1 -> setActiveSheetIndex(0)->mergeCells('A1:G1');
        $hoja1 -> setActiveSheetIndex(0)->setCellValue('A1', 'REPORTE DE EMPLEADORES VALIDADOS');
        ...
        foreach ($respuesta as $clave => $valor) {
            ...
            $hojaActiva -> setCellValue('A' . $i, $cant) 
                        ...
                        -> setCellValue('G' . $i, strtoupper($aprob));
        }
